          ...
          <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 h-full">
            ...
            <div className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-400 text-xs tracking-widest mb-2">FIRST NAME *</label>
                  <input
                    type="text"
                    value={firstName}
                ...
                <div>
                  <label className="block text-gray-400 text-xs tracking-widest mb-2">LAST NAME *</label>
                  <input
                    type="text"
                    value={lastName}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-400 text-xs tracking-widest mb-2">EMAIL *</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block text-gray-400 text-xs tracking-widest mb-2">PHONE</label>
                  <input
                    type="tel"
                    value={phone}
              ...
              <div>
                <label className="block text-gray-400 text-xs tracking-widest mb-2">REASON FOR REACHING OUT</label>
              ...
              <div>
                <label className="block text-gray-400 text-xs tracking-widest mb-2">MESSAGE</label>
                <textarea
                  value={message}
