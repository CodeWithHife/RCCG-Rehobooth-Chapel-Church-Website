...
export default function Give() {
  ...
  return (
    <>
      <section className="relative w-full bg-[#0B1E3D] px-5 sm:px-6 md:px-16 py-16 md:py-28 overflow-hidden min-h-[80vh] flex flex-col justify-center">
        <div className="relative max-w-md mx-auto w-full">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden shadow-2xl shadow-black/40">
            {/* Header strip */}
            <div className="bg-[#112444] px-5 sm:px-6 py-4 flex items-center gap-3 border-b border-white/10">
            ...
            <div className="p-5 sm:p-6 md:p-8 space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-col xs:flex-row sm:flex-row items-start xs:items-center sm:items-center justify-between gap-3">
                ...
                <button
                  onClick={handleCopy}
                  className="w-full xs:w-auto sm:w-auto shrink-0 inline-flex items-center justify-center gap-2 bg-[#D4AF37] text-[#0B1E3D] font-bold text-sm px-5 py-2.5 rounded-full hover:bg-[#c29d2e] transition-colors duration-300"
                >
                  {copied ? (
                    <>
